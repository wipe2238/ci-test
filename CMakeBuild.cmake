...
if( DEFINED ENV{CI} )
	...
	if( DEFINED ENV{APPVEYOR_BUILD_WORKER_IMAGE} )
		...
		if( UNIX AND "$ENV{PLATFORM}" STREQUAL "x32" )
			set( CI_TOOLCHAIN "Linux32" )
		elseif( UNIX AND "$ENV{PLATFORM}" STREQUAL "x64" )
		elseif( WIN32 "$ENV{PLATFORM}" STREQUAL "x32" )
		...
		elseif( "$ENV{APPVEYOR_BUILD_WORKER_IMAGE}" STREQUAL "Ubuntu1604" )
			set( CI_GENERATOR "Unix Makefiles" )
		elseif( "$ENV{APPVEYOR_BUILD_WORKER_IMAGE}" STREQUAL "Ubuntu1804" )
			set( CI_GENERATOR "Unix Makefiles" )
		else()
...
unset( result )
if( CI_TOOLCHAIN )
	set( CI_TOOLCHAIN -DCMAKE_TOOLCHAIN_FILE=CMake/Toolchains/${CI_TOOLCHAIN}.cmake )
endif()
execute_process(
	COMMAND ${CMAKE_COMMAND} ${CI_TOOLCHAIN} -G "${CI_GENERATOR}" "${CMAKE_CURRENT_LIST_DIR}"
